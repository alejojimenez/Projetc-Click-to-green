        ...
        <>
            ...
            <Row className='justify-content-center'>
                ...
                <Col sm={'1'} md={'6'} lg={'6'}>
                    ...
                    <Row className='justify-content-center'>
                        <Col sm={1} md={7} lg={7}>
                            <input type="text" className="form-control mb-4" placeholder="Usuario" name="username" onChange={(evento) => actions.onChangeUser(evento)} value={store.user_signup.username} />

                        </Col>
                        <Col sm={1} md={7} lg={7}>
                            <input type="text" className="form-control mb-4" placeholder="Correo" name="email" onChange={(evento) => actions.onChangeUser(evento)} value={store.user_signup.email}/>
                        </Col>
                        <Col sm={1} md={7} lg={7} >
                            <input type="password" className="form-control mb-4" placeholder="Contraseña" name="password" onChange={(evento) => actions.onChangeUser(evento)} value={store.user_signup.password}/>
                        </Col>
                        <Col sm={1} md={7} lg={7}>
